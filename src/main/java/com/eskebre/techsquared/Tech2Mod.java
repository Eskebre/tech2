package com.eskebre.techsquared;
...
import com.eskebre.techsquared.init.Tech2ModTabs;
...
@Mod("tech2")
public class Tech2Mod {
	public static final Logger LOGGER = LogManager.getLogger(Tech2Mod.class);
	public static final String MODID = "tech2";

	public Tech2Mod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);
		Tech2ModBlocks.REGISTRY.register(modEventBus);
		Tech2ModBlockEntities.REGISTRY.register(modEventBus);
		Tech2ModItems.REGISTRY.register(modEventBus);
		Tech2ModTabs.REGISTRY.register(modEventBus);
		Tech2ModMenus.REGISTRY.register(modEventBus);
