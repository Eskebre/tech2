package com.eskebre.techsquared.client.renderer.item;
...
public class LegacyOverrideSelectItemModel implements ItemModel {
	...
	public static void registerItemModelTypes(RegisterItemModelsEvent event) {
		event.register(Identifier.parse("tech2:legacy_overrides"), LegacyOverrideSelectItemModel.Unbaked.MAP_CODEC);
	}
}